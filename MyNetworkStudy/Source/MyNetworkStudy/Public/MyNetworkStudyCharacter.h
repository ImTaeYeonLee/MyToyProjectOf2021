...
#include "MyNetworkStudyCharacter.generated.h"
...
UCLASS(config=Game)
class AMyNetworkStudyCharacter : public ACharacter
{
	GENERATED_BODY()
...
public:
	...
	TSubclassOf<class AMyNetworkStudyProjectile> ProjectileClass;
