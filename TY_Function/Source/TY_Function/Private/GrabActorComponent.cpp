...
{
	PlayerInputComponent->BindAction("VR_RightGrip", IE_Pressed, this, &UGrabActorComponent::ShowGrabLine);
	PlayerInputComponent->BindAction("VR_RightGrip", IE_Released, this, &UGrabActorComponent::HideGrabLine);
	PlayerInputComponent->BindAction("VR_RightTrigger", IE_Pressed, this, &UGrabActorComponent::GrabAction);
	PlayerInputComponent->BindAction("VR_RightTrigger", IE_Released, this, &UGrabActorComponent::ReleaseAction);
}
